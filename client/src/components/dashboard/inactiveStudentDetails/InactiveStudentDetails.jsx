...
import "./InactiveStudentDetails.css"
...
const InactiveStudentDetails = () => {
  ...
  const handleEdit = ()=>{
    navigate(`/inactive-student-update/${id}`)
  }
      ...
      <div className="dashboard-wrapper">
        <div className="dashboard-right">
          ...
          <div className="edit-container">
            <button className="edit-btn" onClick={handleEdit}><BiEdit  /> Edit</button>
            <button className="edit-btn" onClick={()=>handleDelete(id)}><MdDelete /> Delete</button>
          </div>
...
export default InactiveStudentDetails;
